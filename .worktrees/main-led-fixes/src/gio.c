...
/**
 * @brief Configure pin configuration pin number peripheral pin configuration.
 *
 ...
 * @return No value.
 */
void gio_configure_pin_configuration_pin_number_peripheral_pin_configuration(pin_config_index, configuration_value) uint8_t pin_config_index;
...

{
    ...
    pin_configuration = (uint32_t *)spi_get_spi_transfer_storage(pin_config_index, configuration_value, configuration_value);

/*! @file
 * @brief Minimal reset and clock startup for the standalone ADC diagnostic.
 */

#include "switch_test.h"

/**
 * @brief Enable the peripheral clock domains required by the GPIO test.
 */

...
#define CDDIS_GCLK_OFF   0x01   /* The GCLK domain is disabled when processor is in sleep mode
and no interrupt event is active */
#define CDDIS_HCLK_OFF   0x02   /* The HCLK domain is disabled when processor is in sleep mode
and no interrupt event is active */
